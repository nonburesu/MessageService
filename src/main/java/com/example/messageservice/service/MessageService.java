...
public class MessageService {
    ...
    private final Mail163Service mail163Service;
    ...
    public MessageService(
        ...
        this.mail163Service = mail163Service;
    }
    ...
    private void sendEmail(MessageTask task) throws MessagingException, JsonProcessingException {
        ...
        helper.setFrom("3446994995@qq.com"); // 设置发件人
    ...
    private boolean useMailService163() {
        // 这里可以根据配置或其他条件决定是否使用163邮箱
        return "163".equals(System.getProperty("mail.service.type"));
    }
}